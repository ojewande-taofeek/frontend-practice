...
describe("Test the Notifications component after implementing state", () => {
    const user = userEvent.setup()
    test("verify that clicking on the menu item calls handleDisplayDrawer", async () => {
    ...
    test("verify that after calling handleHideDrawer, the state is updated to be false", async () => {
